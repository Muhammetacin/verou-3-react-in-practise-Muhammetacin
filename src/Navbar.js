        ...
        <div className="hidden w-full md:block md:w-auto" id="mobile-menu">
          <ul className="flex flex-col mt-4 md:flex-row md:space-x-2 md:mt-0 md:text-sm md:font-medium">
            <li>
              <Link
                to="/"
                className="block py-1 pr-3 pl-3 text-white bg-blue-700 rounded-md dark:text-white"
                aria-current="page"
              >
                Home
              </Link>
            ...
            <li>
              <Link
                to="products"
                className="block py-1 pr-3 pl-3 text-gray-700 border-b border-gray-100 hover:bg-blue-700 hover:text-white hover:rounded-md dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:border-gray-700"
                aria-current="page"
              >
                Products
              </Link>
